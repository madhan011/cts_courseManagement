package com.learning.management.courseManagement.config;
...
public class SwaggerConfig implements ServletConfigAware {
    ...
    public Docket dynamicdocs() {
        return new Docket(DocumentationType.SWAGGER_2).
        	...
        	.apis(RequestHandlerSelectors.basePackage("com.learning.management.courseManagement")).build().apiInfo(SwaggerStaticAPiInfo());
